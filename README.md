# Junction TypeScript Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fjunction-api%2Fjunction-typescript)
[![npm shield](https://img.shields.io/npm/v/@junction-api/sdk)](https://www.npmjs.com/package/@junction-api/sdk)

The Junction TypeScript library provides convenient access to the Junction APIs from TypeScript.
...
```sh
npm i -s @junction-api/sdk
```

## Reference

A full reference for this library is available [here](https://github.com/junction-api/junction-typescript/blob/HEAD/./reference.md).
...
const client = new JunctionClient({ apiKey: "YOUR_API_KEY" });
...
const request: Junction.ListBulkOpsLinkRequest = {
    ...
};
```
...
```typescript
const response = await client.labTests.getLabTestCollectionInstructionPdf(...);
...
```typescript
import { LinkClient } from '@junction-api/sdk/link';
...
```typescript
const { data, rawResponse } = await client.link.bulkImport(...).withRawResponse();
...
```typescript
import { JunctionClient, logging } from "@junction-api/sdk";
