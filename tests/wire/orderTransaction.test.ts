...
describe("OrderTransactionClient", () => {
    test("get_transaction (1)", async () => {
        ...
        const response = await client.orderTransaction.getTransaction({
    ...
    test("get_transaction (2)", async () => {
        ...
        await expect(async () => {
            return await client.orderTransaction.getTransaction({
                transactionId: "transaction_id",
            });
    ...
    test("get_transaction_result (1)", async () => {
        ...
        const response = await client.orderTransaction.getTransactionResult({
            transactionId: "transaction_id",
        });
        expect(response).toEqual({
            metadata: {
    ...
    test("get_transaction_result (2)", async () => {
        ...
        await expect(async () => {
            return await client.orderTransaction.getTransactionResult({
                transactionId: "transaction_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
