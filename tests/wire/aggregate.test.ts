...
describe("AggregateClient", () => {
    test("query_one (1)", async () => {
        ...
        const response = await client.aggregate.queryOne({
            userId: "user_id",
            timeframe: {
                type: "relative",
                anchor: "anchor",
    ...
    test("query_one (2)", async () => {
        ...
        await expect(async () => {
            return await client.aggregate.queryOne({
                userId: "user_id",
                timeframe: {
                    type: "relative",
                    anchor: "anchor",
    ...
    test("get_result_table_for_continuous_query (1)", async () => {
        ...
        const response = await client.aggregate.getResultTableForContinuousQuery({
            userId: "user_id",
    ...
    test("get_result_table_for_continuous_query (2)", async () => {
        ...
        await expect(async () => {
            return await client.aggregate.getResultTableForContinuousQuery({
                userId: "user_id",
                queryIdOrSlug: "query_id_or_slug",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    ...
    test("get_task_history_for_continuous_query (1)", async () => {
        ...
        const response = await client.aggregate.getTaskHistoryForContinuousQuery({
            userId: "user_id",
            queryIdOrSlug: "query_id_or_slug",
    ...
    test("get_task_history_for_continuous_query (2)", async () => {
        ...
        await expect(async () => {
            return await client.aggregate.getTaskHistoryForContinuousQuery({
                userId: "user_id",
                queryIdOrSlug: "query_id_or_slug",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
