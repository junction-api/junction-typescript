...
describe("UserClient", () => {
            ...
            users: [
                {
                    ...
                    created_on: "2026-05-06T10:59:48Z",
                    connected_sources: [
                        {
                    ...
                    fallback_time_zone: {
                        id: "Europe/London",
                        source_slug: "manual",
                        updated_at: "2026-05-06T10:59:48Z",
                    },
                    fallback_birth_date: {
                        value: "1989-09-12",
                        source_slug: "manual",
            ...
            users: [
                {
                    ...
                    createdOn: new Date("2026-05-06T10:59:48.000Z"),
                    connectedSources: [
                        {
                            provider: {
                                name: "Oura",
                    ...
                    fallbackTimeZone: {
                        id: "Europe/London",
                        sourceSlug: "manual",
                        updatedAt: new Date("2026-05-06T10:59:48.000Z"),
                    },
                    fallbackBirthDate: {
                        value: "1989-09-12",
                        sourceSlug: "manual",
    ...
    test("create (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            fallback_time_zone: { id: "Europe/London", source_slug: "manual", updated_at: "2026-05-06T10:59:48Z" },
            fallback_birth_date: { value: "1989-09-12", source_slug: "manual", updated_at: "2026-05-06T10:59:48Z" },
            ingestion_start: "ingestion_start",
            ingestion_end: "ingestion_end",
        };
    ...
    test("create (2)", async () => {
        ...
        }).rejects.toThrow(Junction.BadRequestError);
    });
    ...
    test("get_connected_providers (1)", async () => {
        ...
        const response = await client.user.getConnectedProviders({
            userId: "user_id",
        });
        expect(response).toEqual({
            key: [
    ...
    test("get_connected_providers (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getConnectedProviders({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("get_latest_user_info (1)", async () => {
        ...
        const response = await client.user.getLatestUserInfo({
            userId: "user_id",
        });
        expect(response).toEqual({
    ...
    test("get_latest_user_info (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getLatestUserInfo({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("create_insurance (1)", async () => {
        ...
        const response = await client.user.createInsurance({
            userId: "user_id",
    ...
    test("create_insurance (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.createInsurance({
                userId: "user_id",
                payorCode: "payor_code",
                memberId: "member_id",
                relationship: "Self",
    ...
    test("get_latest_insurance (1)", async () => {
        ...
        const response = await client.user.getLatestInsurance({
            userId: "user_id",
            isPrimary: true,
        });
        expect(response).toEqual({
    ...
    test("get_latest_insurance (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getLatestInsurance({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("upsert_user_info (1)", async () => {
        ...
        const response = await client.user.upsertUserInfo({
            userId: "user_id",
            firstName: "first_name",
            lastName: "last_name",
            email: "email",
    ...
    test("upsert_user_info (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.upsertUserInfo({
                userId: "user_id",
                firstName: "first_name",
                lastName: "last_name",
                email: "email",
    ...
    test("get_by_client_user_id (1)", async () => {
        ...
        const response = await client.user.getByClientUserId({
            clientUserId: "client_user_id",
        });
        expect(response).toEqual({
            userId: "56bd81c9-6219-4000-a775-ae85526eba18",
    ...
    test("get_by_client_user_id (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getByClientUserId({
                clientUserId: "client_user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("deregister_provider (1)", async () => {
        ...
        const response = await client.user.deregisterProvider({
            userId: "user_id",
            provider: "oura",
        });
        expect(response).toEqual({
    ...
    test("deregister_provider (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.deregisterProvider({
                userId: "user_id",
                provider: "oura",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    ...
    test("patch (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.patch({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("refresh (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.refresh({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.BadRequestError);
    });
    ...
    test("get_devices (1)", async () => {
        ...
        const response = await client.user.getDevices({
            userId: "user_id",
        });
        expect(response).toEqual([
            {
    ...
    test("get_devices (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getDevices({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("get_device (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getDevice({
                userId: "user_id",
                deviceId: "device_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    ...
    test("get_user_sign_in_token (1)", async () => {
        ...
        const response = await client.user.getUserSignInToken({
            userId: "user_id",
        });
        expect(response).toEqual({
            userId: "user_id",
    ...
    test("get_user_sign_in_token (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.getUserSignInToken({
                userId: "user_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
    ...
    test("create_portal_url (1)", async () => {
        ...
        const response = await client.user.createPortalUrl({
            userId: "user_id",
            context: "launch",
        });
        expect(response).toEqual({
    ...
    test("create_portal_url (2)", async () => {
        ...
        await expect(async () => {
            return await client.user.createPortalUrl({
                userId: "user_id",
                context: "launch",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
