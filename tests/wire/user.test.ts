...
describe("UserClient", () => {
            ...
            users: [
                {
                    ...
                    created_on: "2026-09-23T19:18:36Z",
                    connected_sources: [
                        {
                    ...
                    fallback_time_zone: {
                        id: "Europe/London",
                        source_slug: "manual",
                        updated_at: "2026-09-23T19:18:36Z",
                    },
                    fallback_birth_date: {
                        value: "1989-09-12",
                        source_slug: "manual",
            ...
            users: [
                {
                    ...
                    createdOn: new Date("2026-09-23T19:18:36.000Z"),
                    connectedSources: [
                        {
                            provider: {
                                name: "Oura",
                    ...
                    fallbackTimeZone: {
                        id: "Europe/London",
                        sourceSlug: "manual",
                        updatedAt: new Date("2026-09-23T19:18:36.000Z"),
                    },
                    fallbackBirthDate: {
                        value: "1989-09-12",
                        sourceSlug: "manual",
    ...
    test("create (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            fallback_time_zone: { id: "Europe/London", source_slug: "manual", updated_at: "2026-09-23T19:18:36Z" },
            fallback_birth_date: { value: "1989-09-12", source_slug: "manual", updated_at: "2026-09-23T19:18:36Z" },
            ingestion_start: "ingestion_start",
            ingestion_end: "ingestion_end",
        };
