...
describe("LabTestsClient", () => {
    ...
    test("get_orders (1)", async () => {
        ...
        const rawResponseBody = {
            orders: [
                {
                    user_id: "c1b0c463-1032-4775-bdf5-7807b24dbc51",
                    id: "4a4f4ccd-35b1-4c06-b31f-7d02461f3f36",
                    team_id: "3d7ac9d8-3cd5-4ae9-b189-d9fb0ce53e13",
                    ...
                    details: {
                        type: "testkit",
                        data: {
                            id: "d2df3f82-5d1e-4a10-a2f8-7ab19de7940b",
                            shipment: {
                                id: "738ba1a6-0391-48c7-a201-d0ffdee5fad6",
        ...
        expect(response).toEqual({
            orders: [
                {
                    userId: "c1b0c463-1032-4775-bdf5-7807b24dbc51",
                    id: "4a4f4ccd-35b1-4c06-b31f-7d02461f3f36",
                    teamId: "3d7ac9d8-3cd5-4ae9-b189-d9fb0ce53e13",
                    patientDetails: {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "df5a7cd0-d301-49b1-a094-5d6feae49eac",
            user_id: "567c2bda-de00-4ef6-9703-0efe9a2b6009",
            order_id: "1e2ede98-06a1-45dd-983c-95afa7b18fc3",
            order_transaction_id: "bd940ecd-1e67-4f9c-9892-b9aa54950682",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "df5a7cd0-d301-49b1-a094-5d6feae49eac",
            userId: "567c2bda-de00-4ef6-9703-0efe9a2b6009",
            orderId: "1e2ede98-06a1-45dd-983c-95afa7b18fc3",
            orderTransactionId: "bd940ecd-1e67-4f9c-9892-b9aa54950682",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "012ffe51-263d-4f73-ba17-1e59a7ab0c76",
            user_id: "56ec60c7-1e67-4a97-be55-ebbbfd2bac56",
            order_id: "71fc5f49-e3fd-4b0d-ab25-256aca934fd8",
            order_transaction_id: "32ddc5f7-ddd5-4348-a6f3-174a1e052fe0",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "012ffe51-263d-4f73-ba17-1e59a7ab0c76",
            userId: "56ec60c7-1e67-4a97-be55-ebbbfd2bac56",
            orderId: "71fc5f49-e3fd-4b0d-ab25-256aca934fd8",
            orderTransactionId: "32ddc5f7-ddd5-4348-a6f3-174a1e052fe0",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "aae3ee04-b53d-4fbf-b924-d05daad0c1e7", name: "I'm feeling sick", is_refundable: true },
        ];
        ...
        expect(response).toEqual([
            {
                id: "aae3ee04-b53d-4fbf-b924-d05daad0c1e7",
