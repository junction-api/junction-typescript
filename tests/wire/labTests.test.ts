...
describe("LabTestsClient", () => {
    ...
    test("get_orders (1)", async () => {
        ...
        const rawResponseBody = {
            orders: [
                {
                    user_id: "e86059bd-f0a3-4953-a853-74e19b5d711c",
                    id: "2c36a12a-d22a-4b1a-93a7-c790db865569",
                    team_id: "aede5ab2-fd1b-4a4f-9038-c5e2bc1862cd",
                    ...
                    details: {
                        type: "testkit",
                        data: {
                            id: "35622e6b-2860-4ffd-9b62-10cc309d0bb8",
                            shipment: {
                                id: "f1db9979-0d8b-4ae4-8d96-0449e7bf74d1",
        ...
        expect(response).toEqual({
            orders: [
                {
                    userId: "e86059bd-f0a3-4953-a853-74e19b5d711c",
                    id: "2c36a12a-d22a-4b1a-93a7-c790db865569",
                    teamId: "aede5ab2-fd1b-4a4f-9038-c5e2bc1862cd",
                    patientDetails: {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "6f06bdb2-9dd3-4e61-ba3b-65033a0f8b4d",
            user_id: "264a2dc5-643c-4a19-8343-716521699a54",
            order_id: "0778b9dd-d7e5-4beb-a996-20966746c26c",
            order_transaction_id: "c70aee86-3ad1-4bcd-b474-29bf282f9696",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "6f06bdb2-9dd3-4e61-ba3b-65033a0f8b4d",
            userId: "264a2dc5-643c-4a19-8343-716521699a54",
            orderId: "0778b9dd-d7e5-4beb-a996-20966746c26c",
            orderTransactionId: "c70aee86-3ad1-4bcd-b474-29bf282f9696",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "955e9df8-e2d2-4d6d-a11a-424170e79932",
            user_id: "5e80e27d-f8a9-4f73-b957-89ff0623475c",
            order_id: "950e4b6b-d165-4e25-81f0-171d94a699ed",
            order_transaction_id: "712ddd2c-fc7b-4c78-b036-044a64d07d1f",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "955e9df8-e2d2-4d6d-a11a-424170e79932",
            userId: "5e80e27d-f8a9-4f73-b957-89ff0623475c",
            orderId: "950e4b6b-d165-4e25-81f0-171d94a699ed",
            orderTransactionId: "712ddd2c-fc7b-4c78-b036-044a64d07d1f",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "e8d1b04a-8341-42d8-9ce9-afaa88948ff6", name: "I'm feeling sick", is_refundable: true },
        ];
        ...
        expect(response).toEqual([
            {
                id: "e8d1b04a-8341-42d8-9ce9-afaa88948ff6",
