...
describe("LabTestsClient", () => {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "39db49b5-2dc0-4291-b2fd-b7b9a37ef3ef",
            user_id: "6e4bfc3e-07a0-4df0-8d4a-59baea03fa7d",
            order_id: "3d7f69a4-3288-43c7-9dcf-a51bc331a661",
            order_transaction_id: "82d686ea-21e9-4eeb-8ba1-1503275c1319",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "39db49b5-2dc0-4291-b2fd-b7b9a37ef3ef",
            userId: "6e4bfc3e-07a0-4df0-8d4a-59baea03fa7d",
            orderId: "3d7f69a4-3288-43c7-9dcf-a51bc331a661",
            orderTransactionId: "82d686ea-21e9-4eeb-8ba1-1503275c1319",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "3d281b39-e711-448f-8db8-d0c945f21337",
            user_id: "835f91fa-3ef8-4d41-bd01-4f9daa687b28",
            order_id: "e1f31e78-3e27-4416-a2fe-bdd81758311f",
            order_transaction_id: "e0e5f815-b3d8-48eb-bf2c-9af8c5ba5a09",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "3d281b39-e711-448f-8db8-d0c945f21337",
            userId: "835f91fa-3ef8-4d41-bd01-4f9daa687b28",
            orderId: "e1f31e78-3e27-4416-a2fe-bdd81758311f",
            orderTransactionId: "e0e5f815-b3d8-48eb-bf2c-9af8c5ba5a09",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "4006c64a-eefb-4e59-b1ff-0a3065a6b3dc", name: "I'm feeling sick", is_refundable: true },
        ];
        ...
        expect(response).toEqual([
            {
                id: "4006c64a-eefb-4e59-b1ff-0a3065a6b3dc",
