...
describe("WorkoutsClient", () => {
    test("get (1)", async () => {
        ...
        const response = await client.workouts.get({
            userId: "user_id",
            provider: "provider",
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.workouts.get({
                userId: "user_id",
                startDate: "start_date",
            });
    ...
    test("get_raw (1)", async () => {
        ...
        const response = await client.workouts.getRaw({
            userId: "user_id",
            provider: "provider",
            startDate: "start_date",
            endDate: "end_date",
    ...
    test("get_raw (2)", async () => {
        ...
        await expect(async () => {
            return await client.workouts.getRaw({
                userId: "user_id",
                startDate: "start_date",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    ...
    test("get_by_workout_id (1)", async () => {
        ...
        const response = await client.workouts.getByWorkoutId({
    ...
    test("get_by_workout_id (2)", async () => {
        ...
        await expect(async () => {
            return await client.workouts.getByWorkoutId({
                workoutId: "workout_id",
            });
        }).rejects.toThrow(Junction.UnprocessableEntityError);
    });
