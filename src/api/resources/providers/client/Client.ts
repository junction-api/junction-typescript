...
export class ProvidersClient {
     ...
     * Get Provider list
     *
     * @param {Junction.GetAllProvidersRequest} request
    ...
    ): core.HttpResponsePromise<Junction.ClientFacingProviderDetailed[]> {
    ...
    private async __getAll(
        request: Junction.GetAllProvidersRequest = {},
        requestOptions?: ProvidersClient.RequestOptions,
    ): Promise<core.WithRawResponse<Junction.ClientFacingProviderDetailed[]>> {
