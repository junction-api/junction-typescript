...
export const Question: core.serialization.ObjectSchema<serializers.Question.Raw, Junction.Question> =
    core.serialization.object({
        ...
        constraint: core.serialization.string().optionalNullable(),
...
export declare namespace Question {
    export interface Raw {
        ...
        sequence: number;
        answers: Answer.Raw[];
        constraint?: (string | null | undefined) | null;
