...
export const ProviderConnectionErrorErrorType: core.serialization.Schema<
    serializers.ProviderConnectionErrorErrorType.Raw,
    Junction.ProviderConnectionErrorErrorType
