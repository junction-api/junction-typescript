...
import { BasalBodyTemperatureEntry } from "./BasalBodyTemperatureEntry.js";
import { CervicalMucusEntry } from "./CervicalMucusEntry.js";
import { ClientFacingMenstrualCycleSourceProvider } from "./ClientFacingMenstrualCycleSourceProvider.js";
import { ClientFacingMenstrualCycleSourceType } from "./ClientFacingMenstrualCycleSourceType.js";
import { ClientFacingSource } from "./ClientFacingSource.js";
import { ContraceptiveEntry } from "./ContraceptiveEntry.js";
import { DetectedDeviationEntry } from "./DetectedDeviationEntry.js";
import { HomePregnancyTestEntry } from "./HomePregnancyTestEntry.js";
import { HomeProgesteroneTestEntry } from "./HomeProgesteroneTestEntry.js";
import { IntermenstrualBleedingEntry } from "./IntermenstrualBleedingEntry.js";
import { MenstrualFlowEntry } from "./MenstrualFlowEntry.js";
import { OvulationTestEntry } from "./OvulationTestEntry.js";
import { SexualActivityEntry } from "./SexualActivityEntry.js";

export const ClientFacingMenstrualCycle: core.serialization.ObjectSchema<
    serializers.ClientFacingMenstrualCycle.Raw,
    Junction.ClientFacingMenstrualCycle
> = core.serialization.object({
    id: core.serialization.string(),
    periodStart: core.serialization.property("period_start", core.serialization.string()),
    periodEnd: core.serialization.property("period_end", core.serialization.string().optionalNullable()),
    cycleEnd: core.serialization.property("cycle_end", core.serialization.string().optionalNullable()),
...
export declare namespace ClientFacingMenstrualCycle {
    export interface Raw {
        id: string;
        period_start: string;
        period_end?: (string | null | undefined) | null;
        cycle_end?: (string | null | undefined) | null;
